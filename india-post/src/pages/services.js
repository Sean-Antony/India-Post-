    ...
    return (
        <div className="flex flex-col lg:flex-row min-h-screen bg-[#F7F7F9]">
            ...
            <div className="space-y-4">
              <div className='flex justify-center xl:mt-[30px] 2xl:mt-[50px]'>
                <div className='h-px w-full bg-gray-200'></div>
              </div>
              <div className='flex justify-end space-x-4'>
                <button type="button" className="bg-k1 text-white font-PSB py-3 px-5 rounded-md xl:mt-[30px]" onClick={handleProceed}>
