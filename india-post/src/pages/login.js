            ...
            <form >
              <div className="space-y-6">
                <div>
                  <label
                    htmlFor="userID"
                    className="block text-md 2xl:text-lg font-PSB text-gray-700 mb-2"
                  >
              ...
              <div className="text-right mt-4">
                <a
                  href="#"
                  className="relative font-PM text-sm font-PSB text-k1 group"
                >
                  Forgot password?
              ...
              <div className="flex justify-end flex-col  mt-2 align-middle">
                <button
                  ...
                  className="border border-k1 bg-white text-black font-bold py-2 2xl:py-3 rounded-md"
                >
                ...
                <button
                  type="button"
                  className="bg-k1 text-white font-bold py-2 2xl:py-3 w-full mt-2 rounded-md"
